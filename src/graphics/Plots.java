...
public class Plots {
   ...
   */
  static public void plotLineChartFromCollection(XYSeriesCollection dataset,
   ...
   */
  static public void plotLineChart(double[] data, String name, String x,
      String y) {
    double delta_t = Discretization.getDelta_t();
  ...
  /** @brief TODO */
  static public void plotStepChart(double[] data, String name, String x,
      String y) {
    double delta_t = Discretization.getDelta_t();
    XYSeries s = new XYSeries(name);
    for (int i = 0; i < data.length; i++) {
    ...
    final CategoryPlot plot = new CategoryPlot(dataset2, domainAxis, rangeAxis,
        renderer);
